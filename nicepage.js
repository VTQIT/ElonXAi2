    ...
    function i() {
      return {
        ...
        click: function (t) {
          ...
          if ((a(form), m(form), !w.signatureValidation(form)))
            return (
                ...
                if (
                  ...
                  for (var a, o, u, l = 0; l < 3; l++)
                    (a = L[l]),
                      ...
                      (u = h + l - 1),
                      s.loop && wn() > 2 && (u = st(u)),
                      (o = yn(u)) && (E || o.needsUpdate || !o.bounds)
                        ? (i.cleanSlide(o),
                          i.setContent(a, u),
                          1 === l &&
                      ...
                      o && o.container && (xn(o, S), kn(o), mt(o));
                  E = false;
                }
                (_ = x = i.currItem.initialZoomLevel),
                  (Ce = i.currItem.bounds) &&
                ...
                if (l >= c[T].frame && l <= c[T + 1].frame) {
                  ...
                  for (_ in k.props)
                    if (s.call(k.props, _)) {
                      ...
                      (I = k.props[_].easing(I)),
                        (A = ft(k.props[_].value, E.props[_].value, I)),
                        (A = ht(A)),
                        0 === _.indexOf("@")
                          ? u.setAttribute(_.substr(1), A)
                          : o.setStyle(u, _, A);
...
*/ !(function () {
  ...
  15884: function (t, e, n) {
    ...
    (i.prototype.scroll = function (t) {
      ...
      (i.prototype.update = function (t) {
        var e = "string" == typeof t ? t : o(t.currentTarget).prop("href"),
          hash = (e || "").replace(/^[^#]+/, "");
  ...
  15900: function (t, e, n) {
    ...
    function a(el) {
      ...
      if (product) {
        ...
        t &&
          (u(l(product), t.data), s(l(product), t.data), o(l(product), t.data));
      }
    }
    function o(t, data) {
  ...
  891: function (t, e, n) {
    ...
    i.registerAnimation(n(892)),
      i.registerAnimation(n(895)),
      i.registerAnimation(n(404));
  },
  892: function (t, e, n) {
    "use strict";
    function i(t, e) {
